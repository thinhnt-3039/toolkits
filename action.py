...
def get_index_base_expand_score(random_input, placeables, board, old_loss_score, old_result_score, idx):
    ...
    if idx < 5:
        list_result_check = []
        for expand_score, loss_score, result_score in zip(all_expand_score, all_loss_score, all_result_score):
...
def get_index_base_result_score(random_input, placeables, board, old_loss_score, old_result_score, idx):
    placeables      = find_placeable_slots(board)
    all_loss_score = []
    all_result_score = []
    all_expand_score = []
