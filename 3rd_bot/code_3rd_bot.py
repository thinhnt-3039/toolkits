...
def accumulation(board):
    ...
    for i in range(0, 81):
        if (i + 1) % 9 == 0 or (i + 2) % 9 == 0:
            ...
            if (
                (board[i] == board[i + 1] and board[i + 2] == 0)
                or (board[i] == board[i + 2] and board[i + 1] == 0)
                or (board[i + 2] == board[i + 1] and board[i] == 0)
            ):
    ...
    for i in range(0, 63):
        if (
            (board[i] == board[i + 9] and board[i + 18] == 0)
            or (board[i] == board[i + 18] and board[i + 9] == 0)
            or (board[i + 9] == board[i + 18] and board[i] == 0)
        ):
    ...
    for i in range(0, 63):
        if (i + 1) % 9 == 0 or (i + 2) % 9 == 0:
            ...
            if (
                (board[i] == board[i + 10] and board[i + 20] == 0)
                or (board[i] == board[i + 20] and board[i + 10] == 0)
                or (board[i + 10] == board[i + 20] and board[i] == 0)
            ):
    ...
    for i in range(0, 63):
        if i % 9 == 0 or (i - 1) % 9 == 0:
            ...
            if (
                (board[i] == board[i + 8] and board[i + 16] == 0)
                or (board[i] == board[i + 16] and board[i + 8] == 0)
                or (board[i + 8] == board[i + 16] and board[i] == 0)
            ):
